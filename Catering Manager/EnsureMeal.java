...
public class EnsureMeal {
    ...
    public EnsureMeal(String ctmr, String pav, String gslbs, String vb, String bsmp, String tmp, String cos, String cs, String ssdc, String mgcjr) {
        this.ctmr = ctmr;
        this.pav = pav;
        this.gslbs = gslbs;
        this.vb = vb;
